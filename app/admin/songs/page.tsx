...
// ... [Keep your existing Type definitions if desired, or use the one below] ...
type Song = {
  id: string;
  hymnNumber: number;
  titleMarathi: string;
    ...
    <main className="p-8 max-w-6xl">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5"
        >
      ...
      {/* Statistics Cards - [Keep existing code below unchanged] */}
      ...
      {/* Search Bar - [Keep existing code below unchanged] */}
      ...
      {/* Songs List - [Keep existing code below unchanged] */}
      {loading ? (
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-12 text-center">
          ...
          <p className="text-gray-600 mb-4">
            {search ? "Try adjusting your search terms" : "No songs available in the database"}
          </p>
          {search && (
            <button
              onClick={() => setSearch("")}
